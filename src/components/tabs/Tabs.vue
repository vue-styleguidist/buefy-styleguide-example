...
<script>
    ...
    /**
     * @example ../../../docs-styleguidist/examples/tabs.md
    */
    export default {
        name: 'bTabs',
        components: {
        ...
        props: {
            /**
             * ``v-model`` Binding value, tab index
            */
            value: {
                type: [String, Number],
                default: 0
            ...
            */
            expanded: Boolean,
            /**
             * Type/Style of the tab, optional
            */
            type: String,
            /**
             * Size of the tab, optional
            */
            size: String,
            /**
