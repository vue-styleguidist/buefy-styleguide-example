...
<script>
    ...
    /**
     * @example ../../../docs-styleguidist/examples/dialog.md
    */
    export default {
        name: 'bDialog',
        components: {
        ...
        props: {
            ...
            */
            message: String,
            /**
             * Adds an icon on the left side depending on the ``type``
            */
            hasIcon: Boolean,
            /**
             * Type (color) of the confirm button (and the icon if ``hasIcon``)
            */
            type: {
                type: String,
                default: 'is-primary'
            ...
            */
            ...
            /**
             * Prompt only: input's placeholder
            */
            inputPlaceholder: String,
            /**
             * Prompt only: input's native name
            */
            inputName: String,
            /**
             * Prompt only: input's maxlength
            */
